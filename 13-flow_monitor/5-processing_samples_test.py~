...
#plt.plot(graph, delay,linewidth=0.5)	# plot line graph between graph and delay
...
plt.grid(True)
plt.plot(graph[win_index],delay[win_index],'ro', ls="", ms=3, label='Test Samples - OWD')	# mark congestion points in RED
